...
# !!! Main.UserApp is configured as an alias for Main.MinhaAPIJulia and you might encounter it in some tests
using Main.MinhaAPIJulia, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "MinhaAPIJulia tests" begin
  @includetests ARGS
end
